...
{/* 1. Social Media Orbit Animation */}
<div className="absolute inset-0 flex items-center justify-center opacity-100 group-hover:opacity-0 transition-opacity duration-500">
  ...
  {/* مدار خارجي دوار */}
  <div className="absolute inset-0 rounded-full border-[1.5px] border-dashed border-[#3df1f6]/20 animate-[spinCW_30s_linear_infinite]" />
  <div className="absolute inset-7 rounded-full border border-dashed border-white/6" />
  ...
  <div className="absolute inset-0 animate-[spinCW_22s_linear_infinite]">
    ...
    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rotate-0"
         style={{ transform: 'translate(-50%,-50%) rotate(0deg) translateX(118px)' }}>
      <div className="animate-[spinCCW_22s_linear_infinite]">
        <div className="w-9 h-9 rounded-xl flex items-center justify-center shadow-[0_0_14px_rgba(220,39,67,0.5)]"
    ...
    <div className="absolute top-1/2 left-1/2"
         style={{ transform: 'translate(-50%,-50%) rotate(180deg) translateX(118px)' }}>
      <div className="animate-[spinCCW_22s_linear_infinite]">
  ...
  <div className="absolute inset-0 animate-[spinCCW_15s_linear_infinite]">
    {/* TikTok */}
    <div className="absolute top-1/2 left-1/2"
         style={{ transform: 'translate(-50%,-50%) rotate(70deg) translateX(88px)' }}>
      <div className="animate-[spinCW_15s_linear_infinite]">
        <div className="w-9 h-9 rounded-xl bg-black border border-white/15 flex items-center justify-center shadow-[0_0_12px_rgba(105,201,208,0.4)]">
          <svg viewBox="0 0 24 24" className="w-[18px] h-[18px]">
            <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 0 0-.79-.05 6.34 6.34 0 0 0-6.34 6.34 6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.33-6.34V8.69a8.18 8.18 0 0 0 4.78 1.52V6.76a4.85 4.85 0 0 1-1.01-.07z" fill="#69c9d0"/>
          </svg>
        </div>
      </div>
    </div>
    {/* Meta */}
    <div className="absolute top-1/2 left-1/2"
         style={{ transform: 'translate(-50%,-50%) rotate(250deg) translateX(88px)' }}>
      <div className="animate-[spinCW_15s_linear_infinite]">
        <div className="w-9 h-9 rounded-xl flex items-center justify-center shadow-[0_0_12px_rgba(6,104,225,0.5)]"
             style={{ background: 'linear-gradient(135deg,#0668E1,#0080FB)' }}>
          <svg viewBox="0 0 24 24" className="w-5 h-5" fill="white">
  ...
  <div className="absolute inset-0 animate-[spinCW_10s_linear_infinite]">
    {/* Google */}
    <div className="absolute top-1/2 left-1/2"
         style={{ transform: 'translate(-50%,-50%) rotate(30deg) translateX(58px)' }}>
    ...
    {/* X / Twitter */}
    <div className="absolute top-1/2 left-1/2"
         style={{ transform: 'translate(-50%,-50%) rotate(210deg) translateX(58px)' }}>
      <div className="animate-[spinCCW_10s_linear_infinite]">
  ...
  {/* النقطة المركزية + نبضات */}
  <div className="relative z-20 flex items-center justify-center pointer-events-none">
    <div className="absolute w-16 h-16 rounded-full border border-[#3df1f6]/40 animate-ping" />
    <div className="absolute w-16 h-16 rounded-full border border-[#3df1f6]/20 animate-ping [animation-delay:0.7s]" />
    <svg viewBox="0 0 396 361" className="w-10 h-10 drop-shadow-[0_0_14px_rgba(61,241,246,0.7)]">
      <defs>
        <linearGradient id="lgOrbit" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#3df1f6"/>
          <stop offset="100%" stopColor="#150089"/>
        </linearGradient>
      </defs>
      <path transform="matrix(1,0,0,1,172.5,128)" d="M95.2 0L55.4 77.3C44.5 98.4 39.1 102.2 39.1 102.2C38.2 102.6 36.3 103.3 27.3 104.8C15 102.6 10.3 99 10.3 99C8.7 97.8 4.1 93.4 0 83.2C2.7 83 9 82 17 76.6C19.5 74 24.1 65.8 24.1 65.8L32.7 49.2C36.8 40.6 39.9 35.2 51.5 15.9C71.7 2.3 95.2 0 95.2 0Z" fill="url(#lgOrbit)"/>
      <path transform="matrix(1,0,0,1,128,130)" d="M24.6 49C39.3 41.8 42.4 34.4 43.7 31.5C44.4 28.2 44.4 24.8 44.4 11.2C32.8 0 19.2 0 19.2 0H0L24.6 49Z" fill="url(#lgOrbit)"/>
    </svg>
  </div>

  {/* Creative Agency label */}
  <div className="absolute bottom-8 z-10 pointer-events-none">
    <span className="text-[#3df1f6] text-[9px] font-black tracking-[0.4em] uppercase drop-shadow-md">
      Creative Agency
    </span>
  </div>
        ...
        <div className="flex whitespace-nowrap w-[200%] animate-[scroll-left_40s_linear_infinite] hover:[animation-play-state:paused]">
          ...
          {[...marqueeServicesList, ...marqueeServicesList, ...marqueeServicesList].map((service, idx) => (
            <div key={idx} className="flex items-center">
              <span 
                className="text-4xl md:text-5xl lg:text-6xl font-black uppercase tracking-wider text-transparent mx-6 lg:mx-8 transition-colors duration-300 hover:text-white cursor-default"
      ...
      {/* Influencers Section */}
      <section id="influencers" className="relative py-24 lg:py-32 px-6 lg:px-12 bg-white overflow-hidden">
        {/* Large Background Blobs matching user's image */}
        <MorphingBlob
          color="#150089"
          className="absolute left-[-25%] top-[-10%] w-[70%] h-[120%] opacity-100 hidden lg:block"
        />
        <MorphingBlob
          color="#3df1f6"
          className="absolute right-[-25%] top-[-10%] w-[60%] h-[120%] opacity-100 hidden lg:block"
        />
        {/* Mobile blobs */}
        <div className="lg:hidden">
          <div className="absolute left-[-20%] top-0 w-64 h-64 bg-[#150089]/20 rounded-full blur-3xl" />
          <div className="absolute right-[-20%] bottom-0 w-64 h-64 bg-[#3df1f6]/20 rounded-full blur-3xl" />
        </div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            {/* Left Side - Text with White Background Box */}
            <div className="relative">
              <motion.div
                variants={fadeUpVariants}
                className="bg-white p-8 md:p-20 shadow-[-20px_20px_60px_rgba(0,0,0,0.05)] relative z-20 space-y-8"
              >
                <motion.h2
                  variants={slideInLeft}
                ...
                <motion.div variants={fadeUpVariants}>
                  <MagneticButton>
                    <Link
                      href="#contact"
                      className="inline-flex items-center gap-3 text-sm font-bold group bg-black text-white px-8 py-4 hover:bg-[#3df1f6] hover:text-[#150089] transition-colors rounded-none"
                    >
                      Learn More
              ...
              <div className="relative h-[400px] lg:h-[600px] w-full flex items-center justify-center">
                ...
                >
                  <Image
                    ...
                    width={800}
                    height={800}
                    className="w-full max-w-sm lg:max-w-lg object-contain drop-shadow-[0_30px_60px_rgba(0,0,0,0.2)]"
                    style={{ height: 'auto' }}
                    priority
                  />
                </motion.div>
